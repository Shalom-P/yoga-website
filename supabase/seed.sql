...
-- Class categories
-- Condition / life-stage 1:1 categories (by need, not yoga style) -- see migration 0023.
-- All copy is health-claim-safe (support/complement, alongside medical care).
