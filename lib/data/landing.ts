...
// Descriptions are deliberately health-claim-safe (support/complement, alongside
// medical care — never cure/treat) for the UAE (DHA/MOH) + India (DMRA/ASCI)
// markets. Kept in sync with supabase/migrations/0023 + seed.sql.
const MOCK_CATEGORIES: ClassCategory[] = [
  {
    id: "c1", slug: "diabetes", name: "Diabetes",
    description: "Gentle movement and breathwork to support circulation, healthy weight, and stress management — practised alongside your doctor's care, never replacing it.",
    helps_with: ["Healthy weight", "Gentle activity", "Steady energy", "Stress management", "Feeling more active"],
    long_description: "These gentle one-on-one sessions blend easy movement, comfortable breathing, and relaxation to support an active, balanced daily routine. This is general wellbeing support, never a treatment for any medical condition, and your teacher works alongside your doctor's care, not in place of it. Each session is shaped around your comfort, fitness level, and how you feel that day.",
    ...
    who_for: "Adults looking to support a healthy, active routine and manage stress alongside their regular medical care. This is not a treatment for diabetes or any medical condition.",
  ...
  },
  {
    ...
    description: "Slow, soothing movement and even, natural breathing to support relaxation — a complement to, not a substitute for, your medical care.",
    helps_with: ["Relaxation", "Calmer breathing", "Better sleep", "Lower tension", "Stress management"],
    long_description: "Slow, soothing one-on-one sessions use easy movement and gentle, natural breathing to support deep relaxation and a calmer state of mind. This is general relaxation and stress support, a complement to your medical care and not a substitute for it. Your teacher keeps everything comfortable and unhurried, with no straining or forceful techniques at any point.",
    ...
    who_for: "Adults who want a calming, low-intensity practice for relaxation and stress, alongside their doctor's guidance. This is not a treatment for high blood pressure or any medical condition.",
  ...
  },
  {
    ...
    description: "Safe, gentle sessions for pregnancy and the postnatal period, tailored to each trimester and cleared with your doctor before you begin.",
    helps_with: ["Gentle mobility", "Easing aches", "Better sleep", "Relaxation", "Calmer breathing"],
    long_description: "Gentle, supportive sessions designed for pregnancy and the months after birth, practised only after your doctor or midwife has cleared you, and tailored to your trimester or recovery stage. Practices focus on comfort, easy mobility within a stable range, and rest, avoiding anything strenuous. Your teacher adapts each session week to week and this is not antenatal medical care.",
    ...
    who_for: "Expecting and new mothers, cleared by their doctor or midwife, who want a gentle, supportive practice through pregnancy and recovery. This is not a substitute for antenatal care.",
  ...
  },
  {
    ...
    description: "Soothing, restorative yoga and breathwork that supports balance, sleep, and wellbeing through different life stages — alongside your medical guidance.",
    helps_with: ["Restful practice", "Better sleep", "Daily energy", "Relaxation", "Wellbeing"],
    long_description: "Soothing, restorative one-on-one sessions use gentle movement, breathwork, and relaxation to support your overall sense of wellbeing through different life stages. The focus is on rest, comfort, and steadiness rather than intensity. Breathing stays gentle and natural with no breath-holding, and your teacher checks for pregnancy or medical conditions to adapt the session and complement your own health professional's care.",
    ...
    who_for: "Anyone seeking a gentle, restorative practice to support wellbeing and rest through changing life stages, alongside their own health professional's care.",
  ...
  },
  {
    ...
    who_for: "Adults with everyday stiffness or tension who want gentle movement alongside any treatment they're receiving. This is not a treatment for any injury or condition.",
  ...
  },
  {
    ...
    description: "Restful breath, movement, and meditation to help you manage stress, settle the mind, and rest better — alongside professional support.",
    helps_with: ["Stress management", "A settled mind", "Better sleep", "Mood support", "Focus"],
    long_description: "Restful one-on-one sessions blend gentle movement, breathwork, and meditation to help you manage everyday stress, settle a busy mind, and rest more easily. The pace is calm and the space is private, so you can fully unwind. This is general relaxation and wellbeing support, a complement to and not a substitute for professional mental-health care.",
    ...
    who_for: "Anyone wanting a calm, supportive practice to ease everyday stress, quiet the mind, and rest better. This is not a substitute for mental-health treatment or therapy.",
  ...
  },
  {
    ...
    description: "Energising, sustainable flows scaled to your fitness level that support an active routine and healthy habits as part of your lifestyle.",
    ...
    who_for: "Adults who want an enjoyable, sustainable flow practice to support an active, healthy routine, rather than a guaranteed weight result.",
  ...
  },
  {
    ...
    description: "Slow, supportive yoga for older adults to help support everyday mobility, balance, and confidence — with chair options as needed.",
    helps_with: ["Mobility", "Balance", "Steadiness", "Flexibility", "Relaxation"],
    long_description: "Slow, supportive one-on-one yoga for older adults to help with everyday mobility, balance, and confidence in daily movement. Chair-supported and standing options keep everything safe and accessible. Your teacher works gently at your pace, moving slowly between positions, and adapts each session to suit you, complementing any care from your own health professional.",
  ...
  },
  {
    ...
    description: "Playful, age-appropriate yoga to help children build focus, flexibility, and calm in a fun, friendly 1:1 setting.",
