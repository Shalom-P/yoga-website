        ...
        <table className="w-full min-w-max text-sm">
          <thead>
            <tr>
              ...
              <th className="bg-foreground/4 px-4 py-2.5 text-left text-[11px] font-semibold uppercase tracking-[0.08em] text-muted-foreground whitespace-nowrap">Requested</th>
